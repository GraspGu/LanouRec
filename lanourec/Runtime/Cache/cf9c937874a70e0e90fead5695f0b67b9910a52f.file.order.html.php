<?php /* Smarty version Smarty-3.1.6, created on 2018-04-19 14:04:49
         compiled from "E:/AppServ/www/LanouRec/lanourec/Admin/View\Index\order.html" */ ?>
<?php /*%%SmartyHeaderCode:135375ad8318123bd02-12958491%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'cf9c937874a70e0e90fead5695f0b67b9910a52f' => 
    array (
      0 => 'E:/AppServ/www/LanouRec/lanourec/Admin/View\\Index\\order.html',
      1 => 1524101774,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '135375ad8318123bd02-12958491',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5ad831813cf9e',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5ad831813cf9e')) {function content_5ad831813cf9e($_smarty_tpl) {?><!doctype html>
<html>
<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <title>订单管理--资源回收平台</title>
...
/search/index/search/action/order" method="post">
                            <input name="order_data" type="text" class="form-control form-control-solid" placeholder="搜索..."> 
                        </form>
                    </div>
                </div>
            </div>
                            ...
                            <table class="am-table am-table-striped am-table-hover table-main">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="table-date am-hide-sm-only">产生日期</th>
                                        ...
                                        <td>
                                            <div class="am-btn-toolbar">
                                                <div class="am-btn-group am-btn-group-xs">
                                                    <a href="<?php echo @__CONTROLLER__;?>
/search/action/order/id/<?php echo $_smarty_tpl->tpl_vars['value']->value['order_id'];?>
"><span class="am-icon-copy"></span> 查看 </a>
                                                    <!-- <a href="?index=modify&action=order&id=<<?php ?>?php echo $value['order_id'] ?<?php ?>>"><span class="am-icon-pencil-square-o"></span> 
                                                    ****订单信息不允许修改*****
                                                    ****</a> -->
                                                </div>
                                            </div>
